"""
Django settings for nisarg project.
...
SECRET_KEY = 'django-insecure-+#px@5rb&#e4s@42(_a#acyt*yg4mw!!1+crpv^!!!9fp&=-lm'
...
# smtp configurataion for sending email
...
WSGI_APPLICATION = 'nisarg.wsgi.application'
